...
public class GeneraDirectorioEntity {
    ...
    public void GeneraDirectorioEntity(String directorioEntidad, String nombreEntidad, String entidadMayusculaInicial, Integer tipoSo, String nombreTablaValidada)
        ...
        if (directorioEntity.mkdir()) {
            ...
            //if (directorioEntity.mkdir()) {
              //  System.out.println("   Directorio " + directorioEntity + " creado satisfactoriamente.\n");
           // }
